    ...
    children: [
      {
        ...
        meta: { title: '首页概览', breadcrumb: [{ title: '首页概览' }] },
      },
      {
        path: 'datasource',
        name: 'DataSource',
        component: () => import('@/views/datasource/index.vue'),
        meta: { title: '数据源管理', breadcrumb: [{ title: '数据源管理' }] },
      },
      {
        path: 'datasource/dataset',
        name: 'DataSet',
        component: () => import('@/views/datasource/dataset/index.vue'),
        meta: { title: '数据集配置', breadcrumb: [{ title: '数据集配置' }] },
      },
      {
        ...
        meta: { title: '代码集校准', breadcrumb: [{ title: '代码集校准' }] },
      },
      {
        path: 'upload-monitor',
        name: 'UploadMonitor',
        component: () => import('@/views/upload-monitor/index.vue'),
        meta: { title: '数据上传监控', breadcrumb: [{ title: '数据上传监控' }] },
      },
      {
        path: 'rule/category',
        name: 'RuleCategory',
        component: () => import('@/views/Rule/Category.vue'),
        meta: { title: '规则分类', breadcrumb: [{ title: '质控规则管理' }, { title: '规则分类' }] },
      },
      {
        path: 'rule/list',
        name: 'RuleList',
        component: () => import('@/views/Rule/List.vue'),
        meta: { title: '规则列表', breadcrumb: [{ title: '质控规则管理' }, { title: '规则列表' }] },
      },
      {
        path: 'rule/template',
        name: 'RuleTemplate',
        component: () => import('@/views/Rule/Template.vue'),
        meta: { title: '规则模板', breadcrumb: [{ title: '质控规则管理' }, { title: '规则模板' }] },
      },
      {
        path: 'rule/execute',
        name: 'RuleExecute',
        component: () => import('@/views/Rule/Execute.vue'),
        meta: { title: '手动执行', breadcrumb: [{ title: '质控规则管理' }, { title: '手动执行' }] },
      },
      {
        path: 'result/overview',
        name: 'ResultOverview',
        component: () => import('@/views/result/overview/index.vue'),
        meta: { title: '全局统计', permission: 'result:view', breadcrumb: [{ title: '数据质量结果' }, { title: '全局统计' }] },
      },
      {
        path: 'result/by-rule',
        name: 'ResultByRule',
        component: () => import('@/views/result/by-rule/index.vue'),
        meta: { title: '按规则统计', permission: 'result:view', breadcrumb: [{ title: '数据质量结果' }, { title: '按规则统计' }] },
      },
      {
        path: 'result/detail',
        name: 'ResultDetail',
        component: () => import('@/views/result/detail/index.vue'),
        meta: { title: '问题明细', permission: 'result:view', breadcrumb: [{ title: '数据质量结果' }, { title: '问题明细' }] },
      },
      {
        path: 'report',
        name: 'Report',
        component: () => import('@/views/Report/index.vue'),
        meta: { title: '数据质量报告', breadcrumb: [{ title: '数据质量报告' }] },
      },
      {
        path: 'system/org',
        name: 'SystemOrg',
        component: () => import('@/views/System/Org.vue'),
        meta: { title: '机构管理', breadcrumb: [{ title: '系统管理' }, { title: '机构管理' }] },
      },
      {
        path: 'system/user',
        name: 'SystemUser',
        component: () => import('@/views/System/User.vue'),
        meta: { title: '用户管理', breadcrumb: [{ title: '系统管理' }, { title: '用户管理' }] },
      },
      {
        path: 'system/role',
        name: 'SystemRole',
        component: () => import('@/views/System/Role.vue'),
        meta: { title: '角色管理', breadcrumb: [{ title: '系统管理' }, { title: '角色管理' }] },
      },
      {
        path: 'notification',
        name: 'Notification',
        component: () => import('@/views/Notification/index.vue'),
        meta: { title: '通知消息', breadcrumb: [{ title: '通知消息' }] },
      },
    ],
  },
  {
